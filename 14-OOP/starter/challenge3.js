...
(called'EV') as a child "class" of 'Car'.
...
'accelerate', 'brake' and 'chargeBattery' (charge to 90%). Notice what happens when you 'accelerate'! Hint: Review the definiton of polymorphism 😉
...
const increasedSpeed = this.speed += 20
...
const car1 = new EV('Tesla', 140, 0.23)
